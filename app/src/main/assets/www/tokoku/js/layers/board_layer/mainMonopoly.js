...
var initialPlayerCash=200000;
var initialPlayerBankBalance=20000000;
...
ubsApp.inventoryPerPercentValue = 200000;
   ...
   jsElm.onload=function(){
     ...
     else
     {
        ...
        monopoly.intitializeTemplates();
    	 ...
    	 monopoly.pages.WelcomePage[1].src="<img src=\"images/" + languageSelected +"/logo.png\" style=\"height: 39vh;top:40%;margin: 6%;margin-left: 35%;\"> </img>";
	  ...
	  link.onload=function(){
	   ...
	   jsElm.onload=function(){
             ...
             if(ubsApp.isAndroidEnabled) {
                ...
                ubsApp.studentArray = "[{\r\n\t\"StudentId\": \"STU111451\",\r\n\t\"StudentAge\": 12,\"StudentGender\": \"male\",\"StudentName\": \"Indra\"\r\n}, {\r\n\t\"StudentId\": \"STU111453\",\r\n\t\"StudentAge\": 24,\"StudentGender\": \"male\",\"StudentName\": \"Budi\"\r\n}, {\r\n\t\"StudentId\": \"STU111448\",\r\n\t\"StudentAge\": 32,\"StudentGender\": \"male\",\"StudentName\": \"Wisnu\"\r\n}]";
             }
...
ubsApp.closeGame = function() {
    if(ubsApp.isAndroidEnabled) {
      ...
      window.location.href = "../Tokoku-master/thank_you.html";
    }
